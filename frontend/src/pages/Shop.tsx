...
const Shop: React.FC = () => {
  ...
  const mockProducts = [
    ...
    { _id: '18', name: 'Shev Chivda', price: 95, weight: '250g', category: 'Sweets & Snacks', rating: '4.7', image: 'https://images.unsplash.com/photo-1601050690597-df056fb04791?auto=format&fit=crop&q=80' },
